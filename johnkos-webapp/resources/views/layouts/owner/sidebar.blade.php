<aside
    class="w-[280px] h-screen sticky top-0 overflow-y-auto bg-surface dark:bg-dark-surface p-8 flex flex-col gap-8 border-r-2 border-card-border dark:border-dark-card-border shadow-clay dark:shadow-dark-clay z-10 transition-all duration-300">
