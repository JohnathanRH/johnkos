    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-surface dark:bg-dark-surface rounded-md p-6 shadow-clay dark:shadow-dark-clay transition-all duration-300 ease-in-out border border-card-border dark:border-dark-card-border">
            ...
            <div class="flex items-center gap-3">
                ...
                <p class="text-[36px] font-bold text-primary dark:text-dark-primary">A1</p>
            </div>
        </div>
        ...
        <div class="bg-surface dark:bg-dark-surface rounded-md p-6 shadow-clay dark:shadow-dark-clay transition-all duration-300 ease-in-out border border-card-border dark:border-dark-card-border">
            ...
            <p class="text-[36px] font-bold text-primary dark:text-dark-primary">4x5 <span class="text-base font-medium text-muted dark:text-dark-muted">Meter</span></p>
        </div>

        <!-- Sewa Bulanan -->
        <div class="bg-surface dark:bg-dark-surface rounded-md p-6 shadow-clay dark:shadow-dark-clay transition-all duration-300 ease-in-out border border-card-border dark:border-dark-card-border">
            <h3 class="text-[20px] mb-2 font-poppins font-semibold">Sewa Bulanan</h3>
            <p class="text-[36px] font-bold text-primary dark:text-dark-primary"><span class="text-base font-medium text-muted dark:text-dark-muted">Rp</span> 1.500.000</p>
        </div>
    </div>
    ...
    <div class="p-6 bg-surface dark:bg-dark-surface rounded-md shadow-clay dark:shadow-dark-clay border border-transparent transition-all duration-300">
        <div class="flex justify-between items-start">
            <div class="flex flex-col gap-2">
                <strong class="text-xl font-semibold">Pembayaran April 2024</strong>
