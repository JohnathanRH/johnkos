...
@section('content')
    <div class="bg-surface dark:bg-dark-surface rounded-md p-6 shadow-clay dark:shadow-dark-clay border border-card-border dark:border-dark-card-border">
        <form action="{{ route('owner.kamar.assign', ['kamar' => $kamar->id]) }}" method="POST">
            @csrf
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-2">
                    <div class="mb-5">
                        <label for="name" class="block font-semibold mb-2 text-sm">Nama Lengkap</label>
                        <input type="text" name="name" id="name" class="w-full py-3 px-5 rounded-md border border-transparent bg-background dark:bg-dark-background shadow-input dark:shadow-dark-input outline-none font-sans text-main dark:text-dark-main transition-all duration-200 ease-in-out" placeholder="Nama lengkap penyewa" required>
                    </div>
                    <div class="mb-5">
                        <label for="phone" class="block font-semibold mb-2 text-sm">Nomor Telepon</label>
                        <input type="tel" name="phone" id="phone" class="w-full py-3 px-5 rounded-md border border-transparent bg-background dark:bg-dark-background shadow-input dark:shadow-dark-input outline-none font-sans text-main dark:text-dark-main transition-all duration-200 ease-in-out" placeholder="0812xxxxxxxx" required>
                    </div>
                    {{-- <div class="mb-5">
                     ...
                     <div class="mb-5">
                        <label for="deadline" class="block font-semibold mb-2 text-sm">Tanggal Jatuh Tempo Berikutnya</label>
                        <input type="text" name="deadline" id="deadline" class="datepicker w-full py-3 px-5 rounded-md border border-transparent bg-background dark:bg-dark-background shadow-input dark:shadow-dark-input outline-none font-sans text-main dark:text-dark-main transition-all duration-200 ease-in-out" placeholder="Pilih tanggal..." required>
                    </div>
                </div>
            </div>
